...
- Runesmith Decision Guard blocks autonomous Review or Seal decision synthesis when Review Lens or Seal Audit still has critical or blocking findings, returns a `decision-held` stop, and carries the exact guard findings back to OpenCode, CLI, dashboard, and Runeweave.
