...
- Runesmith Review Lens turns proof, risk, and decision state into a pre-seal checklist with findings, so autonomous Review leads with findings and carries inspectable reasoning instead of a vague approval note.
