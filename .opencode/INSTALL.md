...
Runesmith injects the Runic Covenant, live Control Brief, Loop Pulse, compaction context, automatic mission preparation, automatic evidence capture, recovery, and evidence-gated task advancement. Users do not need to load skills or invoke a workflow by name.
