...
- Worker Dispatch turns routed slots into executable packets with assigned agent, model, tool permissions, file scope, required evidence, lease/claim metadata, and a direct handoff.
