...
- Plan Refinery uses `runesmith_plan_refine` to replace a thin map with proof-backed slices, record the planning decision, and let the shared loop claim independent ready slices.
