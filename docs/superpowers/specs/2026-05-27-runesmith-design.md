...
- A Runesmith Plan Refinery that lets OpenCode remap a thin Covenant mission into ordered proof-backed slices, records the planning decision, persists the capsule, and re-enters the shared loop so independent ready slices are claimed automatically.
