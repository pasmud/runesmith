...
- A Runesmith Decision Guard that refuses to synthesize autonomous Review or Seal decision evidence while Review Lens or Seal Audit has critical or blocking findings, returns a `decision-held` state, and stops Runeweave with the exact guard reason instead of spinning or claiming false completion.
