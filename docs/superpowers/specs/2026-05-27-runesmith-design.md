...
- `runesmith_worker_claim`: claim the next or selected Worker Dispatch packet through its assigned contract, holder, idempotency key, and lease TTL without raw mission or task ids.
