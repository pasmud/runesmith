...
- Run OS executes Runeweave through the same router used by OpenCode and CLI, making the primary dashboard action prove, repair, stop at Faultline, recover, resolve supplied risk decisions, advance, and seal until a stop condition is reached.
